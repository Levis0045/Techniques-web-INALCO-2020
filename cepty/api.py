...
ceptyRestApi.add_resource(ClientsGetPostResource, '/clients', 
                            endpoint='clients_gp_api')
...
# -----------------------------------------------------------------------
"""
Map([<Rule '/v0.1/contributions' (HEAD, POST, GET, OPTIONS) -> contrib_gp>,
 <Rule '/v0.1/clients' (HEAD, POST, GET, OPTIONS) -> clients_gp_api>,
 <Rule '/v0.1/login' (HEAD, POST, GET, OPTIONS) -> clients_login_api>,
 <Rule '/v0.1/home' (HEAD, GET, OPTIONS) -> home_page_api>,
 <Rule '/v0.1/doc' (HEAD, GET, OPTIONS) -> home_page_api>,
 <Rule '/v0.1/' (HEAD, GET, OPTIONS) -> home_page_api>,
 <Rule '/v0.1/contributions/<contrib_id>' (PUT, OPTIONS, HEAD, GET, DELETE) -> contrib_ud_api>,
 <Rule '/v0.1/clients/<client_id>' (PUT, OPTIONS, HEAD, GET, DELETE) -> clients_ud_api>,
 <Rule '/static/<filename>' (HEAD, GET, OPTIONS) -> static>,
 <Rule '/v0.1/<path>' (HEAD, GET, OPTIONS) -> static_files_api>])
"""
